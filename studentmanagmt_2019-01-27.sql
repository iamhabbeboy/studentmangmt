...
# Database: studentmanagmt
# Generation Time: 2019-01-27 19:40:36 +0000
# ************************************************************
...
# Dump of table course_registered
# ------------------------------------------------------------
...
CREATE TABLE `course_registered` (
  ...
  `student_id` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `courses` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `level` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
